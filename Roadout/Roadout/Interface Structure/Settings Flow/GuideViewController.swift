...
class GuideViewController: UIViewController {
    ...
    let guideTips = [
        ...
        GuideTip(title: "Future Road", icon: "eye.fill", description: "Future Road lets you set notifications to remind you to make future reservation", expandedDescription: "Future Road lets you set notifications to remind you to make future reservation. You can delete or add future reservations from the pick screen", highlightedWords: ["notifications", "future"], expandedHighlightedWords: ["notifications", "future", "delete or add"]),
