...
class FindView: UIView {
    ...
    @IBAction func changeTapped(_ sender: Any) {
        ...
        slider.tintColor = UIColor(named: "ExpressFocus")!
        ...
        let doneAction = UIAlertAction(title: "Done", style: .default, handler: { (action: UIAlertAction!) in
            ...
            self.timeLbl.set(textColor: UIColor(named: "ExpressFocus")!, range: self.timeLbl.range(after: "Reserve "))
        })
        doneAction.setValue(UIColor(named: "Dark Orange")!, forKey: "titleTextColor")
        changeAlert.addAction(doneAction)
        changeAlert.addAction(UIAlertAction(title: "Cancel", style: .cancel, handler: nil))
        changeAlert.view.tintColor = UIColor(named: "ExpressFocus")!
    ...
    var changeTitle = NSAttributedString(string: "Change", attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 18, weight: .medium), NSAttributedString.Key.foregroundColor : UIColor(named: "ExpressFocus")!])
    ...
    override func willMove(toSuperview newSuperview: UIView?) {
        ...
        locationLbl.set(textColor: UIColor(named: "ExpressFocus")!, range: locationLbl.range(before: " - Section"))
        timeLbl.text = "Reserve \(minutesValue) Minutes"
        timeLbl.set(textColor: UIColor(named: "ExpressFocus")!, range: timeLbl.range(after: "Reserve "))
