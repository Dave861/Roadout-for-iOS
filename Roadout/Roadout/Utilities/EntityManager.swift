...
class EntityManager {
    ...
    func getFreeParkSpots(_ location: String, _ index: Int, completion: @escaping(Result<Void, Error>) -> Void) {
        ...
        Alamofire.Session.default.request("https://www.roadout.ro/Parking/GetFreeParkingSpots.php", method: .post, parameters: params, encoding: JSONEncoding.default, headers: _headers).responseString { response in
            guard response.value != nil else {
                completion(.failure(EntityErrors.databaseFailure))
                return
            }
