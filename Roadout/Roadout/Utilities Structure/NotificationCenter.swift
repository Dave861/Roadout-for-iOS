...
extension Notification.Name {
    ...
    static let addTimeCardID = Notification.Name("ro.roadout.Roadout.addTimeCardID")
    static let removeTimeCardID = Notification.Name("ro.roadout.Roadout.removeTimeCardID")
    ...
    static let reloadLicensePlateID = Notification.Name("ro.roadout.Roadout.reloadLicensePlateID")
